...
abstract class RSATests(private val publicKey: SigningKey, private val privateKey: SigningKey) {
    private val RS256 = JWS[JWS.Id.RS256]
    private val RS384 = JWS[JWS.Id.RS384]
    private val RS512 = JWS[JWS.Id.RS512]

    abstract fun testRSASignature()
    fun testRSASignature_() {
    ...
    abstract fun testSignWithJwk()
    fun testSignWithJwk_() {
        val jwk = JsonWebKey.format.decodeFromString<JsonWebKey>(testJWK)
    ...
    fun testSignAndVerify_() {
        ...
        assertTrue(RS256.verify(JWT.decodeUnverified(signed).signature!!, publicKey))
    }
